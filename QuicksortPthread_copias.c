/*
 * Cria vários arrays para fazer o mesmo trabalho
 * DESCONTINUADO
 * Como compilar: gcc -o out QuicksortPthread_copias.c -lpthread
 * Como executar: ./out
 * clear && gcc -o out QuicksortPthread_copias.c -lpthread && ./out
 */
